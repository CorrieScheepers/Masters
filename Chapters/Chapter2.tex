...
\begin{xltabular}{\textwidth}{llX}
	...
	\midrule
	\multicolumn{3}{r}{{Continued on next page}} \\ \midrule
	\endfoot
	\endlastfoot
...
\begin{table}[!htb]
	...
	\begin{tabularx}{\textwidth}{lp{3cm}X}
		...
		\subphase{fr:maintenanceFactor} & Maintenance factor & \RaggedRight The maintenance factor measures the amount of maintenance required for a given software system. This will be used to prioritise the software maintenance efforts of the software developers using a scoring system. \\
		\bottomrule
	\end{tabularx}
\end{table}
...
\begin{table}[!htb]
	...
	\begin{xltabular}{\textwidth}{lp{3cm}X}
            \toprule
		\thead{Requirement ID} & \thead{Requirement name} & \thead{Description} \\
            \midrule

            \rowcolor{lightgray}
		\subsubphase{fr:utCategories1} & Users & The users of the software systems can be put in different categories based on who uses the software. This can be both the customer users or the employees using the software. Using the activities of the customer users will provide the data on which systems the development team needs to put their resources into. \\
		...
		\subsubphase{fr:utCategories2} & \RaggedRight User activity types & The user activity types in \Cref{tbl:ch2_userActivityTypes} can be used as a category to compare different types of user-based activities with each other and use a subcategory for categories such as the different users who can use the system (\ref{fr:utCategories1}). \\
            ...
            \rowcolor{lightgray}
		\subsubphase{fr:utCategories3} & Systems or subsystems & The request origin (\ref{fr:lpa5}) of user-based activities can be classified to compare different subsystems and controllers to each other.\\
  
		\subsubphase{fr:utCategories4} & Miscellaneous categories & This user-based activity category type will use the metadata attribute (\ref{fr:lpa7}) of \Cref{tbl:ch2_keyLoggingAttributes}. The other fields that are not set as main categories can also be placed in this category, as they can take multiple forms.\\
		\bottomrule
	\end{xltabular}
\end{table}
