...
\subsection{Obtaining the element which the user interacted with}

\begin{figure}[!htb] % An h :here, t: top, b: bottom.
	\centering % cent the figure
	\includegraphics[width=0.75\textwidth]{Chapter2/event_bubbling/event_bubbling.pdf}
	\caption[JavaScript event bubbling]
	{\textit{JavaScript event bubbling~\cite{EventBubbling}}}\label{fig:ch2_event_bubbling}
\end{figure}
