...
\begin{figure}[!htb] % An h :here, t: top, b: bottom.
	...
	\includegraphics[width=0.7\textwidth]{Images/Chapter2/SystemA_Dashboard/SystemA_Dashboard.pdf}
...
\subsubsection{User activity logging in Dash.php file}
...
In \Cref{sec:SystemA_LoggingPoints} System A mostly relies on the PHP sessions data to obtain the user generated event's data, for System B this data can be obtained by the FilterContext class in ASP.NET MVC. The FilterContext provides contains the following information about the request:
