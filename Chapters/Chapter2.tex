...
In \Cref{fig:ch2_Dash_PHP_Flow,fig:ch2_DetailView_Flow} 
...
\begin{figure}[!htb] % An h :here, t: top, b: bottom.
	...
	{\textit{User activity logging mechanism database interaction}}\label{fig:CH2_SystemA_DB_Iteraction_FlowDiagram}
\end{figure}
