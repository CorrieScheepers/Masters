...
\Cref{fig:ch2_developmentOfSolution} is a high-level overview of the development of the solution. The 
...
\begin{table}[!htb]
	...
	\begin{tabularx}{\textwidth}{|l|l|X|}
		...
		\hline \phase{fr:loggingPoints} & User's device & The device that the user uses to access the website from where the user-based activity events are generated.\\
		\hline \phase{fr:logTools} & User-generated events & These are the captured user-based activity events that have been identified by the logging point and will be sent to the server.\\
		\hline
	\end{tabularx}
\end{table}
