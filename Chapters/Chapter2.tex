...
\begin{figure}[!htb] % An h :here, t: top, b: bottom.
	\centering % cent the figure
	\includegraphics[width=0.7\textwidth]{Chapter2/event_bubbling/event_bubbling.pdf}
...
\begin{figure}[!htb] % An h :here, t: top, b: bottom.
	...
	\caption[JavaScript event propagation]
	{\textit{JavaScript event propagation~\cite{EventBubbling}}}\label{fig:ch2_element_capturing}
\end{figure}
