...
In \Cref{sec:ch1_objectives} the objectives of the study are divided into two main parts that need to be implemented to solve the identified problem. The logging mechanism and log analysis of the logs obtained. A basic system design can be made for the logging mechanism. 

The two main parts are to create a logging mechanism to capture user-based activity logs and log analysis to prioritise software maintenance of the study objectives in \Cref{sec:ch1_objectives} is illustrated in \Cref{fig:ch2_developmentOfSolution}.
