...
\begin{landscape}
	\begin{figure}[!htb]
		\centering % cent the figure
		\includegraphics[width=0.95\linewidth]{img/ch3/analysis/subsystems_1.pdf}
	...
	\begin{figure}[!htb]
		\centering % cent the figure
		\includegraphics[width=0.95\linewidth]{img/ch3/analysis/subsystems_2.pdf}
		\caption[Case study 1 subsystem activities part 1]
	...
	\begin{figure}[!htb]
		\centering % cent the figure
		\includegraphics[width=0.95\linewidth]{img/ch3/analysis/subsystems_3.pdf}
		\caption[Case study 1 subsystem activities part 1]
