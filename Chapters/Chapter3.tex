...
for the test system, the maintenance prioritising recommendations can be made as described in \Cref{sec:ch2_utilisationImprovements}.
...
\begin{table}[!htb]
	...
	\begin{tabularx}{\textwidth}{|X|X|X|}
		\hline \textbf{System} & $P_X$ & $A_X$ \\
		\hline System1 & 226 & 11 \\
		\hline System2 & 269 & 5 \\
		\hline System3 & 156 & 8 \\
		\hline System4 & 155 & 1 \\
		\hline System5 & 145 & 13 \\
		\hline System6 & 154 & 8 \\
		\hline
	\end{tabularx}
\end{table}
