...
\begin{itemize}
	...
	\begin{itemize}
		\item More complex software systems are used with multiple different user activity types than case study A and B.
...
\begin{itemize}
	...
	\item Log quality for similar logging mechanisms is about the same to compare software systems to each other in a log analysis.
