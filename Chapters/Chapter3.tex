...
\Cref{tbl:ch2_utilisationCategories} provides the functional requirements for various utilisation categories. By comparing these categories with each other in the user logs obtained, different categories can be compared, as shown in \Cref{fig:ch3_UAT_menuAnalysis}. Furthermore, \Cref{fig:ch3_UAT_menuActivities} compares different types of user activity.
