...
In \Cref{fig:ch3_caseBBreakdown} the Dash user activity type is about $99.5\%$ of all recorded user activities. System B has fewer subsystems that require the user to interact with the web page to add data. The system mostly has web pages that display data only for the user. There weren't any Report user activity types as the users didn't create any reports to export from these subsystems.
...
\begin{figure}[!htb]
	...
	{\textit{Maintenance performance calculation for system B}}\label{fig:ch3_sbS1S246}
\end{figure} 
...
The user activity breakdown in \Cref{fig:ch3_caseCBreakdown} the majority of the user activities is \texttt{MenuAccessed} user activity type. 
