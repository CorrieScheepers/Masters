...
\begin{tcolorbox}[colback=gray!5!white, colframe=deepblue!80!black, title=Analyzing Forty Years of Software Maintenance Models\cite{Lenarduzzi2017}]
	...
	\hfill
	\begin{minipage}[t]{0.65\textwidth}
		Obtained and implemented a systematic analysis of 1044 papers from 1970 to 2015 about software maintenance models
	\end{minipage}
...
\begin{tcolorbox}[colback=gray!5!white, colframe=deepblue!80!black, title=Central Audit Logging Mechanism in Personal Data Web Services\cite{Hasiloglu2018}]
	...
	\hfill
	\begin{minipage}[t]{0.65\textwidth}
		This study demonstrates the use of a central logging mechanism or logging points to capture
		logs in Web service. It doesn't t specifically captures user-based data but adds additional
		security measures when capturing sensitive data. 
	\end{minipage}
	\tcblower
