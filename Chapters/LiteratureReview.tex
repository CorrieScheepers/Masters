\begin{tcolorbox}[colback=gray!5!white, colframe=deepblue!80!black, title=On the Relationship between Software Complexity and Maintenance Costs\cite{Ogheneovo2014}]
	...
	\hfill
	\begin{minipage}[t]{0.65\textwidth}
		Used three different software operating systems to compare their estimated development, maintenance costs, lines of code and code complexity. This is used the analysis to determine the relationship between the software complexity and maintenance costs.
	\end{minipage}
	...
	\hfill
	\begin{minipage}[t]{0.65\textwidth}
		The results showed that the estimated maintenance costs is high enough that software complexity needs to management to reduce these costs.
	\end{minipage}
...
\begin{tcolorbox}[colback=gray!5!white, colframe=deepblue!80!black, title=Metric-based tracking management in software maintenance\cite{Tang2010}]
	...
	\hfill
	\begin{minipage}[t]{0.65\textwidth}
		This study explores what happens when software maintenance needs to be implemented with certain roleplayers involve.
	\end{minipage}
	...
	\hfill
	\begin{minipage}[t]{0.65\textwidth}
		The results showed that there specifically is a management issue when implementing software maintenance. 
	\end{minipage}
	...
	\hfill
	\begin{minipage}[t]{0.65\textwidth}
		The study has recommeded that a practical software maintenance model needs to be implemented for to resolve the management issue to make the maintenance process more efficient.
	\end{minipage}
	\tcblower
...
\begin{tcolorbox}[colback=gray!5!white, colframe=deepblue!80!black, title=A cost model for software maintenance \& evolution\cite{Sneed2004}]
	...
	\hfill
	\begin{minipage}[t]{0.65\textwidth}
		Attempted to evaulte the cost involved for a software system by implementting a prediction cost analysis of multiple types of maintenance actvities.
	\end{minipage}
	...
	\hfill
	\begin{minipage}[t]{0.65\textwidth}
		The results showed that the estimated maintenance costs depended on multple factors such as the size of the deveopment team, code complexity and code quality.
	\end{minipage}
...
\begin{tcolorbox}[colback=gray!5!white, colframe=deepblue!80!black, title=Trends in software maintenance tasks distribution among programmers: A study in a micro software company\cite{Stojanov2017}]
	...
	\hfill
	\begin{minipage}[t]{0.65\textwidth}
		Maintenance tasks were classified in different types and dsitruted among different developers with multiple test distribtuion techniques.
	\end{minipage}
	...
	\hfill
	\begin{minipage}[t]{0.65\textwidth}
		The distrubution techniques was able to effectively split up the maintenance task between the developers and improved scheduling for the tasks were made.
	\end{minipage}
...
\begin{tcolorbox}[colback=gray!5!white, colframe=deepblue!80!black, title=Supporting Software Architecture Maintenance by Providing Task-specific Recommendations \cite{Galster2019}]
	\begin{minipage}[t]{0.25\textwidth}
		\textbf{Study summary:}
	\end{minipage}
	\hfill
	...
	\hfill
	\begin{minipage}[t]{0.65\textwidth}
		Attempt to address the lack of information which developers have when trying to implement maintenance.
	\end{minipage}
...
\begin{tcolorbox}[colback=gray!5!white, colframe=deepblue!80!black, title=Analyzing Forty Years of Software Maintenance Models\cite{Lenarduzzi2017}]
	...
	\hfill
	\begin{minipage}[t]{0.65\textwidth}
		Obtained and implemented a systematic analysis on 1044 papars from 1970 to 2015 about software maintenance models
	\end{minipage}
	...
	\hfill
	\begin{minipage}[t]{0.65\textwidth}
		The results showed the common aspects software maintenance lacks in industry and the common issues of software maintenance.
	\end{minipage}
	...
	\begin{minipage}[t]{0.65\textwidth}
		...
		adaptability of software maintenance models, little comparison in literature due to closed
...
\begin{tcolorbox}[colback=gray!5!white, colframe=deepblue!80!black, title=A Software Maintenance Methodology: An Approach Applied to Software Aging\cite{Araujo2021}]
	\begin{minipage}[t]{0.25\textwidth}
		\textbf{Study summary:}
	\end{minipage}
	\hfill
	...
	\hfill
	\begin{minipage}[t]{0.65\textwidth}
		Implemented a software rejuvenation method by implementing maintenance on certain systems and evaluating the system performance afterwards.
	\end{minipage}
	...
	\hfill
	\begin{minipage}[t]{0.65\textwidth}
		The results showed that applying the software rejuvenating method on ceratin systems did indeed improve system performance.
	\end{minipage}
...
\begin{tcolorbox}[colback=gray!5!white, colframe=deepblue!80!black, title=Tools and Benchmarks for Automated Log Parsing\cite{Zhu2019}]
	...
	\hfill
	\begin{minipage}[t]{0.65\textwidth}
		Compared multiple third-party log parsers performance to each other with different benchmarks.
	\end{minipage}
	...
	\hfill
	\begin{minipage}[t]{0.65\textwidth}
		The results showed the robustness, efficiency and accuracy of these log parses with the benchmarking data.
	\end{minipage}
...
\begin{tcolorbox}[colback=gray!5!white, colframe=deepblue!80!black, title=A Systematic Review of Logging Practice in Software Engineering\cite{Rong2018}]
	...
	\begin{minipage}[t]{0.65\textwidth}
		...
		discussed in \Cref{apx:loggingPractice}. This emphasizes the lack of research done on
		logging practices.
	\end{minipage}
	...
	\hfill
	\begin{minipage}[t]{0.65\textwidth}
		Created multiple reaserch quations to obtain and analyse reaserch done for logging practice in software engineering.
	\end{minipage}
	...
	\hfill
	\begin{minipage}[t]{0.65\textwidth}
		The results showed that the estimated relevant research done each year and development topic of each paper catergorised.
	\end{minipage}
...
\begin{tcolorbox}[colback=gray!5!white, colframe=deepblue!80!black, title=Learning to Log: Helping Developers Make Informed Logging Decisions \cite{Zhu2015}]
	\begin{minipage}[t]{0.25\textwidth}
		\textbf{Study summary:}
	\end{minipage}
	\hfill
	\begin{minipage}[t]{0.65\textwidth}
		This study summarises the importance of how to log and what to log to aid software
	...
	\hfill
	\begin{minipage}[t]{0.65\textwidth}
		The results showed that benchmark results of the tool's perfomance with different learning models.
	\end{minipage}
...
\begin{tcolorbox}[colback=gray!5!white, colframe=deepblue!80!black, title=Towards a better assessment of event logs quality\cite{Kherbouche2017}]
	...
	\hfill
	\begin{minipage}[t]{0.65\textwidth}
		Created metrics for event log quality assessment on artificial and real-life case studies.
	\end{minipage}
	...
	\hfill
	\begin{minipage}[t]{0.65\textwidth}
		The results have been validated with real and synthetic data that validated the event log quality metrics.	
	\end{minipage}
	...
	\begin{minipage}[t]{0.65\textwidth}
		...
		log quality to make the logs consistent and complete. It also ensures that the logging
		mechanism can accurately capture the logs with the least structural and behavioural
		complexity. 
	\end{minipage}
	\tcblower
...
\begin{tcolorbox}[colback=gray!5!white, colframe=deepblue!80!black, title=Central Audit Logging Mechanism in Personal Data Web Services\cite{Hasiloglu2018}]
	\begin{minipage}[t]{0.25\textwidth}
		\textbf{Study summary:}
	\end{minipage}
	\hfill
	...
	\hfill
	\begin{minipage}[t]{0.65\textwidth}
		This study demostrates the use of central logging mechanism or logging points to capture
		logs in Web service. It doens' t specifically captures user-based data but adds additional
		security measures when capturing the sensitive data. 
	\end{minipage}
	\tcblower
...
\begin{tcolorbox}[colback=gray!5!white, colframe=deepblue!80!black, title=Tracking User Activities and Marketplace Dynamics in Classified Ads\cite{Waqar2017}]
	\begin{minipage}[t]{0.25\textwidth}
		\textbf{Study summary:}
	\end{minipage}
	\hfill
	...
	\hfill
	\begin{minipage}[t]{0.65\textwidth}
		Created models to track user actviities when the user intercats with web page ads.
	\end{minipage}
	...
	\hfill
	\begin{minipage}[t]{0.65\textwidth}
		The results showed the perfomance and evaluation of each model used.
	\end{minipage}
