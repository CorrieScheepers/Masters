...
\chapter{Agile software development methodology}

\begin{figure}[!htb]
	\centering % cent the figure
	\includegraphics[width=0.5\textwidth]{Chapter1/agile_model/agile_model.pdf}
	\caption[Basic agile model of software development]
	{\textit{Basic agile model of software development \cite{Jain2018}}}\label{fig:apx_softwareAgileModel}
\end{figure} 

 The agile model for software development in \Cref{fig:apx_softwareAgileModel} consists of seven basic phases that need to be implemented \cite{Jain2018, Sinha2021}. The agile process breaks the methods needed for software development into smaller tasks:
 \begin{itemize}
	\item \textbf{Requirement Analysis:} This first phase is where the software's functional and non-functional requirements are defined which also can determine the software system's economic and technical feasibility. 
	\item \textbf{Design:} This second phase is where the software's architecture is designed based on the functional requirements it needs to fulfil.
	\item \textbf{Implementation:} After designing the software system architecture it can be implemented into an executable version of the software product.
	\item \textbf{Testing:} The executable software product needs to be tested to validate that all the software's functional requirements are met. At this stage, software testing is also implemented to find any errors, software bugs or any other faults in the software system and fix the identified issues.
	\item \textbf{Deployment:} The production version of the software system is deployed and made available to the users.
	\item \textbf{Feedback:} The final phase for the released software product is when feedback is provided back to the development team about the operation of the software system.
 \end{itemize}
