...
literature in \Cref{chap:1} that can identify strategies needing software maintenance. \par The study
...
\begin{enumerate}[label=\textbf{\Roman*.}]	
	...
	resources by implementing a suitable generic methodology to identify these systems fully. This is defined in \Cref{chap:1} from the literature where software maintenance is
