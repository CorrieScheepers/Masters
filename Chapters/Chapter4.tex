...
\begin{enumerate}[label=\textbf{\Roman*.}]
	...
	\item \textbf{Study objectives} \par The study objectives for this study that were defined in \Cref{sec:ch1_objectives} and have been met in are outlined \Cref{tbl:ch4_ValidationStart}. 
