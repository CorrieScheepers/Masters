...
identified from literature in \Cref{chap:1} that can identify systems needing software
...
The method in \Cref{chap:2} is used on different case studies in \Cref{sec:ch3_caseStudies}.
...
\begin{enumerate}[label=\textbf{\Roman*.}]	
	...
	systems fully. This is defined in \Cref{chap:1} from the literature where software maintenance is
