...
There exist various adoptions of the LPC listed in \Cref{tbl:ch1_SDLC} for various SDLC methodologies that are used in the software development industry \cite{Al-Saiyd2015, Jain2018}. Each LPC ensures that the software development is correctly implemented if it is part of the adopted SDLC methodology. The SDLC methodology is implemented for the entire life cycle of the software system.\par The implementation of the  In the actual implementation of the SDLC methodology, some design patterns could stray away from the initial software designs \cite{Reimanis2016}. \par This can be due to unforeseen issues occurring during the Development phase due to some time or other resource constraints. This can also happen in the Operational and Maintenance phase to implement new design patterns for the software modification not implemented correctly. The software system's initial design might also not be flexible enough for any newer modifications. \par In both situations, some software code may be workarounds or shortcuts to resolve problems. These short-term benefits will not always translate to good long-term software quality due to prioritising functionality above good software design patterns. This decreased quality of software code will from technical debt if the software development is not correctly implemented \cite{DeLeon-Sigg2020, Reimanis2016}.\par Technical debt will always be present to some degree in software systems in its entire life cycle. The Operations and Maintenance phase of the software system is where it is usually resolved. Creating and modifying the user requirements by implementing maintenance is needed to avoid \cite{DeLeon-Sigg2020}:
...
Software maintenance of the Operations and Maintenance LPC phase is an essential task in software development. It can directly reduce the cost and effort to create new software systems or modify them in the future and reduce technical debt \cite{Thamburaj2017, DeLeon-Sigg2020}. 
