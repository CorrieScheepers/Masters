...
\begin{itemize}
	...
	\item \textbf{Control:} Developers retain direct control over the attributes and data captured in logs with a traditional logging mechanism, enabling specific customization based on the application's requirements.
	...
	\item \textbf{Compatibility:} Traditional logging mechanisms enjoy widespread support and easy integration into existing software systems without the need for specialised AI infrastructure
\end{itemize}
