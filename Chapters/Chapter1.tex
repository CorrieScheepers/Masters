...
\begin{table}[!htb]
	...
	\begin{tabularx}{\textwidth}{|l|X|}
		...
		\hline \textbf{Site intercation} & The different Web sites the user is accessing during their active Web session. This would also contain all the information about: 
		\begin{itemize}
