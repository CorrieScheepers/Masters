...
\begin{landscape}
	\begin{table}[!htb]
		...
		\begin{tabularx}{\linewidth}{|l|X|X|X|X|X|X|X|}
			\hline \textbf{Ref.} & \multicolumn{3}{c|}{\textbf{Software maintenance}}  &  \multicolumn{2}{c|}{\textbf{Event logging}} & \multicolumn{2}{c|}{\textbf{System utilisation analysis}} \\ 
			\hline 
			& \textbf{Types} & \textbf{Problems} & \textbf{Prioritisation} & & & & \\ 
		
			\hline \cite{Ackermann2009} & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark \\
			\hline
		\end{tabularx}	
	\end{table}
\end{landscape}
