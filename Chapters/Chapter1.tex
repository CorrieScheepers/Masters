...
\begin{table}[!htb]
	...
	\begin{tabularx}{\linewidth}{lXX}
		...
		Models & \RaggedRight Software maintenance models and implementation in industry. & \RaggedRight \begin{enumerate}
			...
			\item Did the study discuss different software maintenance models and implementation of the model?
		\end{enumerate} \\
		...
		\end{enumerate}\\
		\rowcolor{lightgray}
		Models and prioritisation & How to implement software maintenance models and prioritisation techniques. & \RaggedRight \begin{enumerate}
...
\begin{table}[!htb]
	...
	\begin{tabularx}{\linewidth}{lXX}
		...
		\midrule
		\rowcolor{lightgray}
		Points & \RaggedRight How to implement software maintenance models and prioritisation techniques used in industry. & \RaggedRight \begin{enumerate}
...
\begin{table}[!htb]
	...
	\begin{tabularx}{\linewidth}{lXX}
		...
		\thead{Topic}  & \thead{Description} & \thead{Evaluation criteria}\\
		\midrule
		Utilisation & \RaggedRight Software maintenance types and implementation in industry. & \RaggedRight \begin{enumerate}
