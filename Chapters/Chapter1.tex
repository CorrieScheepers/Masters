...
Before the logs can be parsed to a structured data set, the key attributes need to be defined for the event log \cite{Bekeneva2020}. The attributes describing the event log in \Cref{tbl:ch1_logBasicAttributes} are the essential attributes a log event should have. 
