...
The event log quality model in \Cref{fig:ch1_EventQModel} consists of four different levels to define each property of the event log model:
...
This chapter contains the results for the defined methodology to create a logging mechanism for system utilisation analysis of Chapter 2. The obtained results will be discussed and validated if it resolved the problem statement of \Cref{sec:ch1_problemStatement} and fulfilled the objectives of the study in \Cref{sec:ch1_objectives}.
