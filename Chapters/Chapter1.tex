...
Using the defined criteria created for the state-of-the-art topics in \Cref{tbl:ch1_soaEventLogging,tbl:ch1_soaLogAnalysis,tbl:ch1_soaSoftwareMaintennace} the state of art for the obtained studies is mad in \Cref{tbl:ch1_stateOfTheArt2}.
...
\begin{tcolorbox}[colback=gray!5!white, colframe=deepblue!80!black, title=Trends in software maintenance tasks distribution among programmers: A study in a micro software company\cite{Stojanov2017}]
	...
	\hfill
	\begin{minipage}[t]{0.65\textwidth}
		This study's decision-making results are created from the obtained maintenance tasks of the developers. It specifically only looks at the contribution of these maintenance task from each developer and how efficiently distribute the work among them.
	\end{minipage}
	\tcblower
...
\begin{tcolorbox}[colback=gray!5!white, colframe=deepblue!80!black, title=Supporting Software Architecture Maintenance by Providing Task-specific Recommendations \cite{Galster2019}]
	...
	\hfill
	\begin{minipage}[t]{0.65\textwidth}
		This study discusses the different maintenance types implemented in the industry and the need for software maintenance. These study define the maintenance types and typical activities associated when implementing it for the Operations and Maintenance LCP of \Cref{tbl:ch1_SDLC}.
	\end{minipage}
	...
	\hfill
	\begin{minipage}[t]{0.65\textwidth}
		These studies examines the software maintenance process in industry not the improvement of it. Mainly focusses on the types of maintenance task needed and that the correct approach to implementing maintenance is needed for it be efficient.
	\end{minipage}
	\tcblower
...
\begin{tcolorbox}[colback=gray!5!white, colframe=deepblue!80!black, title=Analyzing Forty Years of Software Maintenance Models\cite{Lenarduzzi2017}]
	...
	\hfill
	\begin{minipage}[t]{0.65\textwidth}
		This study aims to analyse different software maintenance models and their characteristics for the last 4 decades.
	\end{minipage}
	...
	\hfill
	\begin{minipage}[t]{0.65\textwidth}
		This study didn't provide any ways to improve software maintenance but on the limitations on software maintenance in industry. This study highlighted these limitations by the slow adaptability of software maintenance models, limited comparison in literature due to closed source models and replicability of the researched studies.
	\end{minipage}
	\tcblower
...
\begin{tcolorbox}[colback=gray!5!white, colframe=deepblue!80!black, title=A Software Maintenance Methodology: An Approach Applied to Software Aging\cite{Araujo2021}]
	...
	\hfill
	\begin{minipage}[t]{0.65\textwidth}
		The study primarily discuss the implementation of suitable software maintenance models for software maintenance activities. These studies review classification and prioritisation methodologies and comparing different software maintenance models.
	\end{minipage}
	...
	\hfill
	\begin{minipage}[t]{0.65\textwidth}
		ALthough software maintenance improvemenets where made to rejuvenate software systems. The study could not provide a guideline on how 
	\end{minipage}
	\tcblower
