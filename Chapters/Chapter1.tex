...
\begin{table}[!htb]
	...
	\begin{tabularx}{\linewidth}{lXX}
		\toprule[line width]
		\textbf{Topic}  & \textbf{Description} & \textbf{Evaluation criteria}\\
		\midrule
...
\begin{table}[!htb]
	...
	\begin{tabularx}{\linewidth}{p{0.05\textwidth}YYYYYY}
		\toprule
		\textbf{Ref.} & \RaggedRight \textbf{Types} & \RaggedRight \textbf{Problems} & \RaggedRight \textbf{Prioritisation} & \textbf{Parsing} & \textbf{Points} & \RaggedRight \textbf{Utilisation} \\ 		
		\midrule
		\rowcolor{lightgray}
