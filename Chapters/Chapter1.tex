...
\begin{table}[!htb]
	...
	\begin{tabularx}{\textwidth}{|c|X|X|X|X|X|}
		\hline \textbf{Ref.} & \textbf{User activity types} & \textbf{Log attributes} & \textbf{Logging points} & \textbf{Log extraction and visualisation} & \textbf{System utilisation analysis} \\
		\hline 1 & 2 & 3 & 4 &  5 & 6 \\
            \hline \cite{Bekeneva2020} & \Checkmark & \Checkmark & \Checkmark & \Checkmark  & \Checkmark \\
		\hline
	\end{tabularx}
\end{table}
