...
\begin{xltabular}{\linewidth}{|l|X|}
	...
	\hline \cite{Ogheneovo2014} & Defines the different problems with implementing software maintenance. It also studies the relationship with the explored complexities that causes problems in software maintenance in \Cref{sec:ch1_maintenanceProblems}. \\
