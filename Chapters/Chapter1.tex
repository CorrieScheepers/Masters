...
With the log parsing and log points defined in \Cref{sec:ch1_loggignPoints}, a log analysis can be made from the stored event logs. The log analysis is the data mining process focused on the software system's generated event logs \cite{Slaninova2014,Hasiloglu2018}.\par The log analysis will use the defined log attributes in \Cref{tbl:ch1_logBasicAttributes} to complete it. Each software system will have some variation of the log attributes in \Cref{tbl:ch1_logBasicAttributes}. For a Web-based application, the log attributes will also contain any data about the requests between a Web server and a Web client and its responses \cite{Slaninova2014, Dhanalakshmi2016}. This will also reflect on the log level at which weblogs are obtained for log analysis.
