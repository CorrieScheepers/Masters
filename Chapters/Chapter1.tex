...
\begin{figure}[!htb] % An h :here, t: top, b: bottom.
	...
	\includegraphics[width=0.5\textwidth]{Images/Chapter1/Cost_of_fixing_bugs/Cost_of_fixing_bugs.pdf}
...
\begin{figure}[!htb] % An h :here, t: top, b: bottom.
	\centering % cent the figure
	\includegraphics[width=0.6\textwidth]{Images/Chapter1/IEEE_Model/IEEE_Model.pdf}
	\caption[IEEE model]
...
\begin{figure}[!htb] % An h :here, t: top, b: bottom.
	\centering % cent the figure
	\includegraphics[width=0.85\textwidth]{Images/Chapter1/Maintenance_flow/Maintenance_Flow.pdf}
...
\begin{figure}[!htb] % An h :here, t: top, b: bottom.
	\centering % cent the figure
	\includegraphics[width=0.9\textwidth]{Images/Chapter1/Ronga2018.pdf}
...
\begin{figure}[!htb] % An h :here, t: top, b: bottom.
	\centering % cent the figure
	\includegraphics[width=0.9\textwidth]{Images/Chapter1/Event_Log_Model/Event_Log_Model.pdf}
