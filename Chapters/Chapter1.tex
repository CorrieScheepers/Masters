...
\begin{figure}[!htb] % An h :here, t: top, b: bottom.
	\centering % cent the figure
	\includegraphics[width=0.8\textwidth]{Chapter1/Log_Parsing_Example/Log_Parsing_Example.pdf}
