...
\begin{xltabular}{\linewidth}{|l|X|}
	...
	\hline \cite{Ogheneovo2014} &  \\

	\hline \cite{Tang2010} & This study explores how software maintenance tasks are implemented with a practical software maintenance model. Look at the decision-making process of prioritising adaptive and perfective software maintenance types. \\
	...
	\hline \cite{Stojanov2017} & This study examines the software maintenance efforts when implementing a software maintenance model. It also examines how software developers prioritise and divide these maintenance tasks. \\

	\hline \cite{Hasan2012,Ping2010, Galster2019, Niu2018} & Discusses the different maintenance types implemented in the industry and the need for software maintenance. These studies define the maintenance types and typical activities associated when implementing it for the Operations and Maintenance LCP of \Cref{tbl:ch1_SDLC}. \\
...
\begin{tcolorbox}[colback=gray!5!white, colframe=deepblue!80!black, title=My nice heading\cite{Jans2012}]
	\begin{minipage}[t]{0.25\textwidth}
		Column 1 content goes here.
		\end{minipage}
		\hfill
		\begin{minipage}[t]{0.65\textwidth}
			Defines the different problems with implementing software maintenance. It also studies the relationship with the explored complexities that causes problems in software maintenance in \Cref{sec:ch1_maintenanceProblems}.
		\end{minipage}
		\tcblower
